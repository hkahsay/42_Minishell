...
// {
// 	printf(GGREEN "Execution pipe_cmd\n" RS);
// 	char	*cmd_path;
// 	// char	*msg;
// // 	int		exit_status;
...
// 	{
// 		printf(GGREEN "Execution pipe_cmd builtin_cmd\n" RS);
// 		ppline->pp_exit = execute_builtin(&ppline); //execute_single_builtin(ppline)
// 		return (ppline->pp_exit);
// 	}
// 	else
// 	{
// 		printf(GGREEN "Execution pipe_cmd no_builtin path_cmd\n" RS);
// 		if (!execute_cmd(ppline))
...
// 	if ((ppline)->ppline_idx == 1 && ppline->pp_red_status == 1  && ppline->pp_heredoc_status == 1)
// 		execute_heredoc(ppline); //one cmd at first, but have to adapt to all
// 	if ((ppline)->ppline_idx == 1 && ppline->pp_red_status == 1  && ppline->pp_heredoc_status == 0)
// 	{
// 		red_pid = fork();
// 		if (red_pid < 0)
// 			msg_error("error redir: ", errno);
// 		if (red_pid == 0) // child process
// 		{
// 			// close_fd(&ppline);
// 			if ((ppline)->pp_outfile > 1)
// 			{
...
// 				close(fd_out);
// 			}
// 			else if ((ppline)->pp_infile > 1)
// 			{
// 				printf("PP_infile: %d\n", fd_in);
// 				dup2(fd_in, STDIN_FILENO);
// 				close(fd_in);
// 			}
// 			if (!(execute_pipe_cmd(ppline)))
...
// 		// 	// if (check_if_builtin(ppline->pp_first_cmd))
// 		// 	// {
// 		// 	// 	printf(GGREEN "Execution multi cmd builtin\n" RS);
// 		// 	// 	ppline->pp_exit = execute_builtin(&ppline); //execute_single_builtin(ppline)
// 		// 	// 	return (ppline->pp_exit);
// 		// 	// }
// 		// 	// else
// 		// 	// {
// 		// 	// 	printf(GGREEN "Execution no_builtin path_cmd\n" RS);
// 		// 	// 	if (!execute_cmd(ppline))
// 		// 	// 		msg_error("error executing cmd: ", errno);
// 		// 	// }
// 		// }
// 		close_fd(&ppline);
// 		if (waitpid(red_pid, &exit_status, 0) == -1)
...
// 	while (pp_curr)
// 	{
// 		// fd_out = (ppline)->pp_outfile;
// 		// fd_in = (ppline)->pp_infile;
// 		if (num_pipes > 0 && pipe(pp_fd) == -1)
// 			msg_error("error redir: ", errno);
// 		pp_pid = fork();
// 		if (pp_pid == -1)
// 			msg_error("error redir: ", errno);
...
// 				fd_in = pp_fd[0];
// 			}
// 			if (waitpid(pp_pid, &exit_status, 0) == -1)
// 				msg_error("waitpid: ", errno);
// 			if (WIFEXITED(exit_status))
// 				ppline->pp_exit = WEXITSTATUS(exit_status);		
// 		}
// 		ppline->pp_red_status = 0;
// 		num_pipes++;
// 	}
// 	printf("PP_outfile: %d\n", (pp_curr)->pp_outfile);
// 	printf("PP_infile: %d\n", (pp_curr)->pp_infile);
...
// 	int		exit_status;
	...
	if (check_if_builtin(ppline->pp_first_cmd))
	{
		printf(GGREEN "Execute_single_builtin\n\n" RS);
		ppline->pp_exit = execute_builtin(&ppline); //execute_single_builtin(ppline)
		// return (ppline->pp_exit);
	}
	else
	...
	return (ppline->pp_exit); //EXIT_SUCCESS
}
...
void execute(t_cmd *cmd, int cmd_num, t_envnode *mini_env)
{
	...
	if (ppline->ppline_idx == 1 && ppline->pp_red_status == 0 && check_if_builtin(ppline->pp_first_cmd))
	{
...
// 	if (exit_status = execute_builtin(&ppline);
